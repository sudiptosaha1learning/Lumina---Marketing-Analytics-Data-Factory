        ...
        customers: [
          {
            ...
            name: "Lars V.",
            currentVehicle: "Range Rover PHEV",
            currentVariant: "P440e Autobiography LWB 2022",
            buybackEquity: "+€5,800",
            renewalScore: 0.91,
            upsellScore: 0.89,
            cancellationRisk: "Very Low (0.05)",
            leadScore: 0.94,
            career: "Head of Sustainability — ASML",
            location: "Amsterdam-Zuid, Netherlands",
            tenure: "6 years / 3 vehicles",
            lifetimeValue: "€412,000",
            missionFitReason: "Highest equity PHEV in Amsterdam cluster; strong EV intent signalled via configurator; SEAI-equivalent Dutch MIA subsidy eligible",
            recommendedAction: "Range Rover Electric SV private preview + MIA subsidy briefing + equity bridge financing",
            contactWindow: "Tuesday–Thursday 11am–2pm CET",
            preferredChannel: "Personal Relationship Manager + in-app",
          },
          {
            id: "anna-d",
            name: "Anna D.",
            currentVehicle: "Defender 110 PHEV",
            currentVariant: "X-Dynamic HSE P400e 2021",
            buybackEquity: "+€4,200",
            renewalScore: 0.86,
            upsellScore: 0.84,
            cancellationRisk: "Low (0.09)",
            leadScore: 0.90,
            career: "Senior Partner — McKinsey Amsterdam",
            location: "Oud-Zuid, Amsterdam",
            tenure: "4 years / 2 vehicles",
            lifetimeValue: "€298,000",
            missionFitReason: "PHEV Defender owner in equity window; Benelux EV incentive eligible; app engagement high",
            recommendedAction: "Defender Electric Edition priority allocation + Benelux EV grant modelling + home charger installation",
          ...
          },
          {
            ...
            name: "Pieter N.",
            currentVehicle: "Range Rover Sport",
            currentVariant: "P400e PHEV HSE Dynamic 2022",
            buybackEquity: "+€3,900",
            renewalScore: 0.82,
            upsellScore: 0.80,
            cancellationRisk: "Low (0.12)",
            leadScore: 0.87,
            career: "Private Equity Director",
            location: "Apollolaan, Amsterdam",
            tenure: "5 years / 2 vehicles",
            lifetimeValue: "€244,000",
            missionFitReason: "PCP contract ending Q2 2026; equity confirmed; Dutch BEV infrastructure among best in Europe",
            recommendedAction: "RR Sport Electric Dynamic spec event + full equity bridge + MIA subsidy walkthrough",
        ...
        customers: [
          {
            ...
            name: "Thomas K.",
            currentVehicle: "Range Rover PHEV",
            currentVariant: "P400e Vogue SE 2021",
            buybackEquity: "+€5,100",
            renewalScore: 0.88,
            upsellScore: 0.86,
            cancellationRisk: "Low (0.08)",
            leadScore: 0.92,
            career: "Managing Director — Hapag-Lloyd",
            location: "Harvestehude, Hamburg",
            tenure: "7 years / 3 vehicles",
            lifetimeValue: "€388,000",
            missionFitReason: "High-equity PHEV; German BEV incentive (Umweltbonus) eligible; InControl app power user; strong EV consideration score",
            recommendedAction: "Range Rover Electric SV private preview in Hamburg + Umweltbonus grant briefing + equity bridge",
          ...
          },
          {
            ...
            name: "Sabine H.",
            currentVehicle: "Defender 110",
            currentVariant: "P400e X-Dynamic HSE 2022",
            buybackEquity: "+€4,600",
            renewalScore: 0.84,
            upsellScore: 0.87,
            cancellationRisk: "Low (0.10)",
            leadScore: 0.91,
            career: "Architect — own practice",
            location: "Blankenese, Hamburg",
            tenure: "5 years / 2 vehicles",
            lifetimeValue: "€276,000",
            missionFitReason: "PHEV Defender loyalist in equity window; high EV configurator engagement; sustainability-conscious buyer profile",
            recommendedAction: "Defender Electric Edition bespoke design consultation + home wall-box installation package",
          ...
          },
          {
            ...
            cancellationRisk: "Low (0.14)",
            leadScore: 0.86,
            career: "Head of Digital — Beiersdorf",
            location: "Eppendorf, Hamburg",
            tenure: "4 years / 2 vehicles",
            lifetimeValue: "€219,000",
            missionFitReason: "Lease ending May 2026; equity positive; tech-forward profile aligned with RR Electric digital features",
            recommendedAction: "RR Sport Electric premiere invite + digital feature walkthrough + equity bridge modelling",
            contactWindow: "Tuesday 9am–11am CET",
            preferredChannel: "In-app + Email",
          },
        ],
      },
      {
        id: "paris-jlr",
        name: "JLR Paris Élysées",
        ...
        customers: [
          {
            ...
            leadScore: 0.91,
            career: "Managing Partner — Ardian",
            location: "16th arrondissement, Paris",
            tenure: "8 years / 4 vehicles",
            lifetimeValue: "€524,000",
            missionFitReason: "Highest-LTV customer in France cluster; PHEV owner in equity window; bonus écologique eligible; EV configurator sessions logged",
            recommendedAction: "Range Rover Electric SV Atelier Paris private event + bonus écologique briefing + bespoke equity bridge",
          ...
          },
          {
            ...
            name: "Jean-Pierre L.",
            currentVehicle: "Defender 90",
            currentVariant: "P300 X-Dynamic HSE 2021",
            buybackEquity: "+€3,700",
            renewalScore: 0.80,
            upsellScore: 0.83,
            cancellationRisk: "Low (0.13)",
            leadScore: 0.88,
            career: "Investment Director — BNP Paribas",
            location: "7th arrondissement, Paris",
            tenure: "5 years / 2 vehicles",
            lifetimeValue: "€231,000",
            missionFitReason: "Defender loyalist; equity confirmed; Paris ZFE regulations driving EV conversion urgency",
            recommendedAction: "Defender Electric Edition preview + ZFE compliance briefing + bonus écologique + equity bridge",
          ...
          },
          {
            ...
            name: "Marie T.",
            currentVehicle: "Range Rover Sport",
            currentVariant: "P400e HSE Dynamic 2022",
            buybackEquity: "+€4,000",
            renewalScore: 0.83,
            upsellScore: 0.81,
            cancellationRisk: "Low (0.11)",
            ...
            tenure: "4 years / 2 vehicles",
            lifetimeValue: "€284,000",
            missionFitReason: "PCP ending Q2 2026; ZFE compliance pressure accelerating EV decision; high configurator engagement on RR Sport Electric",
            recommendedAction: "RR Sport Electric private presentation at Paris Élysées + ZFE grant briefing + equity bridge",
