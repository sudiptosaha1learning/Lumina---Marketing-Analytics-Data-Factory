...
export type Timeframe = "Q1 2025" | "Q2 2025" | "Q3 2025" | "Q4 2025" | "FY 2025";
...
export const modelCards: ModelCardData[] = [
  {
    ...
    pedigree: {
      ...
      nextScheduledRun: "2025-07-15 06:00 UTC",
      slaCompliance: "99.8%",
  ...
  },
  {
    ...
    pedigree: {
      ...
      nextScheduledRun: "2025-07-14 12:00 UTC",
      slaCompliance: "99.5%",
  ...
  },
  {
    ...
    shortTitle: "Renewal",
    metric: "High-Equity Leases Ending Q3",
    ...
    insightSummary: {
      ...
      "North America": "4,210 leases ending Q3 — 62% showing proactive renewal intent; avg. equity position $9,240",
    ...
    pedigree: {
      ...
      nextScheduledRun: "2025-07-14 22:00 UTC",
      slaCompliance: "99.9%",
  ...
  },
  {
    ...
    pedigree: {
      ...
      nextScheduledRun: "2025-07-14 12:30 UTC",
      slaCompliance: "99.3%",
  ...
  },
  {
    ...
    pedigree: {
      ...
      nextScheduledRun: "2025-07-15 04:00 UTC",
      slaCompliance: "99.7%",
  ...
  },
  {
    ...
    insightSummary: {
      ...
      "North America": "Defender 90 owners showing 0.74 propensity to upgrade to Defender 110 MHEV; SUV demand index at 5-yr high",
    ...
    pedigree: {
      ...
      nextScheduledRun: "2025-07-14 23:00 UTC",
      slaCompliance: "99.1%",
  ...
  },
  {
    ...
    insightSummary: {
      ...
      "North America": "2025 MY Range Rover Autobiography commands +$8.4k over book value; scarcity premium driven by 14-week order bank",
    ...
    pedigree: {
      ...
      nextScheduledRun: "2025-07-14 18:00 UTC",
      slaCompliance: "99.9%",
...
export const missions: Mission[] = [
  {
    ...
    because: {
      ...
      dataPoints: [
        ...
        { model: "Renewal Model (v5.1.0)", finding: "750 Range Rover leases ending Q3 with >$8k equity — 90-day critical window open", weight: "High" },
    ...
    therefore: {
      ...
      tactics: [
        ...
        "Priority allocation on Range Rover Electric launch allotment (Q4 2025)",
      ...
      timeline: "Launch: 21 July 2025 | Close: 30 September 2025",
        ...
        customers: [
          {
            ...
            missionFitReason: "High equity PHEV + early EV adopter profile + active InControl app user + lease ends Sep 2025",
  ...
  },
  {
    ...
    therefore: {
      ...
      timeline: "Launch: 28 July 2025 | Rolling: Q3 2025",
  ...
  },
  {
    ...
    because: {
      title: "The Data Correlation",
      dataPoints: [
        { model: "Upselling Engine (v4.0.3)", finding: "Defender 90 owners showing 0.74 propensity for 110 MHEV upgrade; SUV demand at 5-yr high", weight: "High" },
    ...
    therefore: {
      ...
      timeline: "Launch: 01 August 2025 | Q4 delivery priority",
...
export const reasoningSteps = [
  ...
  { id: 3, text: "Accessing Renewal Model (v5.1.0)... 8,912 high-equity leases flagged for Q3", delay: 1600, models: ["buyback", "renewal"] },
