...
export const missions: Mission[] = [
  ...
  },
  {
    ...
    subtitle: "Convert standard-line accounts to high-throughput OCTA-grade production programs",
    priority: "Strategic",
    ...
    because: {
      title: "The Data Correlation",
      dataPoints: [
        { model: "Upselling Engine (v4.0.3)", finding: "Standard-line accounts showing 0.74 propensity for high-throughput OCTA-grade upgrade; category demand at 6-yr high", weight: "High" },
        { model: "Intelligent Account ID (v4.2.1)", finding: "Sealed Air & Mondi incumbent accounts displaying 0.68 conquest affinity toward Vantage OCTA-grade lines", weight: "High" },
        ...
        { model: "Value Re-Commitment Model (v6.0.1)", finding: "Standard-line 2021/22 programs at +$5.8k avg margin — optimal upgrade economics for OCTA step-up", weight: "Medium" },
    ...
    therefore: {
      title: "The Strategic Insight",
      strategy: "Target high-margin standard-line accounts with an OCTA-grade high-throughput production line experience event. Leverage the scarcity narrative (limited capacity slots) with a priority reservation window to drive urgency.",
      tactics: [
        "Invitation-only OCTA 'Capability Unleashed' plant experience at flagship innovation centres",
        ...
        "OCTA customisation studio access (bespoke structure programme, 6-week lead time)",
        ...
        customers: [
          {
            ...
            missionFitReason: "High-throughput enthusiast profile + active plant-efficiency user + high margin + OCTA design-studio session 3 times",
            recommendedAction: "OCTA-grade priority reservation + Innovation Centre event invite + bespoke structure studio booking",
          ...
          },
          {
            ...
            missionFitReason: "High-speed line owner; margin premium confirmed; OCTA social engagement + comparison research against competitor high-speed lines",
            recommendedAction: "OCTA Capability Unleashed invite + preferential financing proposition + priority bespoke allocation",
        ...
        customers: [
          {
            ...
            missionFitReason: "Tech-manufacturing professional; OCTA social media engagement high; competitor high-speed line comparison research detected",
            recommendedAction: "Innovation Centre OCTA line experience + German engineering showcase narrative",
          ...
          },
          {
            ...
            recommendedAction: "OCTA innovation-centre line experience invitation + performance-line financing at preferential rate",
        ...
        customers: [
          {
            ...
            missionFitReason: "Standard-line account in margin window; OCTA social engagement confirmed; high-throughput lifestyle profile",
            recommendedAction: "OCTA Capability Unleashed regional plant event + bespoke structure studio visit",
          ...
          },
          {
            ...
            missionFitReason: "High-throughput account in margin window; OCTA curiosity signals online; competitor comparison search noted",
            recommendedAction: "OCTA reservation priority + 90-day margin preservation guarantee + preferential financing",
